                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="inner-content">
                            <div class="title">
                                <h2>ادارة العقود الالكترونيه</h2>
                            </div>
                            <div class="breadcrumb-menu">
                                <ul>
                                    <li><a href="index.html">الرئيسيه</a></li>
                                    <li><a href="services.html">خدماتنا</a></li>
                                    <li class="active">ادارة العقود الالكترونيه</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-9">
                        <div class="service-details-style4__content">
                            <div class="service-details-style4-img-box">
                                <img src="assets/images/resources/service-detail-img-2.jpg" alt="">
                            </div>
                            ...
                            <div class="service-details-choose-box">
                                <div class="inner-title">
                                    <h2>الخدمات المقدمة في ادارة العقود الالكترونيه</h2>
                                </div>
