...
<link rel="stylesheet" href="assets/css/responsive.css" />
    ...
    <title>اللؤلؤه العقاريه</title>
    <!-- Favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/favicons/apple-touch-icon.png" />
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/favicons/favicon-32x32.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/favicons/favicon-16x16.png" />
    <link rel="manifest" href="assets/images/favicons/site.webmanifest" />
    <meta name="description" content="Roofan HTML 5 Template " />
            ...
            <div id="handle-preloader" class="handle-preloader">
                ...
                <div class="animation-preloader">
                    ...
                    <div class="txt-loading">
                        <span data-text-preloader="العقارية" class="letters-loading">
                           العقارية
                        </span>
                        <span data-text-preloader="اللؤلؤه" class="letters-loading">
                           اللؤلؤه
                        </span>
                    ...
                    <div class="sidebar-info-contents">
                        <div class="content-inner">
                            ...
                            <div class="content-box">
                                <h3>اللؤلؤه العقارية<br> </h3>
                                <div class="inner-text">
                                    <p>
                                        منشأة عقارية معتمدة ومتخصصة في إدارة ألاملاك والتسويق العقاري منذ عام 2009 
                                    </p>
                                </div>
                            </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="inner">
                                            ...
                                            <div class="text">
                                                <p> جده حي المروه<br> شارع حمزه البركاني</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="inner">
                                            ...
                                            <div class="text">
                                                <p><a href="mailto:info@example.com">info@aloloah.com</a></p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="inner">
                                            ...
                                            <div class="text">
                                                <p><a href="tel:966563322441">966563322441</a></p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="inner">
                                            ...
                                            <div class="text">
                                                <p>Working Hrs : 9.30am to 10.30pm</p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="inner-content">
                            <div class="title">
                                <h2>ادارة الشقق المؤثثة</h2>
                            </div>
                            <div class="breadcrumb-menu">
                                <ul>
                                    <li><a href="index.html">الرئيسيه</a></li>
                                    <li><a href="services.html">خدماتنا</a></li>
                                    <li class="active">ادارة الشقق المؤثثة</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-9">
                        <div class="service-details-style4__content">
                            <div class="service-details-style4-img-box">
                                <img src="assets/images/resources/service-detail-img-5.jpg" alt="">
                            </div>
                            <div class="service-details-style4-text-box">
                                <h2>Roof Frame Design</h2>
                                <div class="text-1">
                            ...
                            <div class="service-details-choose-box">
                                <div class="inner-title">
                                    <h2>الخدمات المقدمة في ادارة الشقق المؤثثة</h2>
                                </div>
                    ...
                    <div class="col-xl-3">
                        <div class="service-details-sidebar-box">
                            ...
                            <div class="service-details-page-links">
                                <div class="inner-title">
                                    <h3>الادارات والاقسام</h3>
                                    <div class="border-box"></div>
                                </div>
                                <ul>
                                    
                                        <a href="service-single-1-6.html">ادارة الامـلاك العقـاريه</a>
                                        
                                    </li>
                                    <li class="current">
                                        <a href="service-single-1-5.html">ادارة الشقق المخدومه</a>
                                        
                                    </li>
                                    <li>
                                        <a href="service-single-1-4.html">ادارةالتسويق الـعقـاري</a>
                                        
                                    </li>
                                    <li>
                                        <a href="service-single-1-2.html">ادارة العقود الالكترونيه</a>
                                        
                                    </li>
                                    <li>
                                        <a href="service-single-1-3.html">ادارة صـيـانـةالعـقـارات</a>
                                    </li>
                                    <li>
                                        <a href="service-single-1-1.html">ادارةالتـطويـر الـعـقاري</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <ul class="footer-contact-info-box1">
                                ...
                                <li>
                                    <div class="footer-contact-info-box1__single">
                                        ...
                                        <div class="text">
                                            <p>Email us:</p>
                                            <h5><a href="mailto:contact@roofan.com">contact@roofan.com</a></h5>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="footer-contact-info-box1__single">
                                        ...
                                        <div class="text">
                                            <p>Call us on:</p>
                                            <h5><a href="tel:2512353256">+ 1800 456 7890</a></h5>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="container">
                        <div class="bottom-inner">
                            <div class="copyright-text">
                                <p>
                                    &copy; Copyright <a href="index.html">Roofan</a> 2022. All right reserved.<br>
                                </p>
                            </div>
